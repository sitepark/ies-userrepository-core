...
@JsonDeserialize(builder = ReassignUsersToRolesRequest.Builder.class)
@SuppressWarnings({"PMD.AvoidFieldNameMatchingMethodName"})
public final class ReassignUsersToRolesRequest {

  @NotNull private final List<Identifier> roleIdentifiers;

  @NotNull private final List<Identifier> userIdentifiers;

  private ReassignUsersToRolesRequest(Builder builder) {
  ...
  public boolean equals(Object o) {
    return (o instanceof ReassignUsersToRolesRequest that)
  ...
  public static final class Builder {
    ...
    public ReassignUsersToRolesRequest build() {
      return new ReassignUsersToRolesRequest(this);
    }
  }
}
