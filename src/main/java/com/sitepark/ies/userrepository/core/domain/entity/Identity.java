...
/**
 * The <code>Identity</code> interface represents a user's identity
 * for authentication purposes. Classes like {@link LdapIdentity}
 * implement this interface to specify how users can
