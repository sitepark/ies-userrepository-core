...
class RevokeRolesFromUsersTest {
  ...
  private RevokeRolesFromUsers usecase;
  ...
  void setUp() {
    ...
    this.usecase =
        new RevokeRolesFromUsers(userRepository, roleRepository, roleAssigner, accessControl);
  }
  ...
  void testUserNotWritable() {
    ...
    assertThrows(
        ...
        () ->
            this.usecase.revokeRolesFromUsers(
  ...
  void testAssignRolesToUsers() {
    ...
    verify(this.roleAssigner).revokeRolesFromUsers(List.of("1", "2"), List.of("3", "4"));
  }
  ...
  void testResolveUserAnchor() {
    ...
    verify(this.roleAssigner).revokeRolesFromUsers(List.of("1"), List.of("3", "4"));
  }
  ...
  void testResolveRoleAnchor() {
    ...
    verify(this.roleAssigner).revokeRolesFromUsers(List.of("1", "2"), List.of("3"));
  }
