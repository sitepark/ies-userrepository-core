...
class AssignRolesToUsersTest {
    ...
    assertThrows(
        ...
        () ->
            this.usecase.assignRolesToUsers(
                AssignRolesToUsersRequest.builder().userIds("1", "2").roleIds("3", "4").build()));
  }
  ...
  void testEmptyUserIdentifiers() {
    ...
    this.usecase.assignRolesToUsers(AssignRolesToUsersRequest.builder().roleIds("3", "4").build());
  ...
  void testEmptyRoleIdentifiers() {
    this.usecase.assignRolesToUsers(AssignRolesToUsersRequest.builder().userIds("1", "2").build());
