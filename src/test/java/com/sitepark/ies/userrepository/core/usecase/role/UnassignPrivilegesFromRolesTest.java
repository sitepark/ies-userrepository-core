...
class UnassignPrivilegesFromRolesTest {
  ...
  private UnassignPrivilegesFromRoles usecase;
  ...
  void setUp() {
    ...
    this.usecase =
        new UnassignPrivilegesFromRoles(
            roleRepository,
            privilegeRepository,
            roleAssigner,
            accessControl,
  ...
  void testEmptyRoleIdentifiers() {
    ...
    this.usecase.unassignPrivilegesFromRoles(
        UnassignPrivilegesFromRolesRequest.builder().privilegeIds("3", "4").build());
  ...
  void testEmptyPrivilegeIdentifiers() {
    this.usecase.unassignPrivilegesFromRoles(
        UnassignPrivilegesFromRolesRequest.builder().roleIds("1", "2").build());
