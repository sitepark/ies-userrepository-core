...
class UpsertUserTest {
  ...
  private UpsertUser useCase;

  @BeforeEach
  void setUp() {
    this.accessControl = mock(AccessControl.class);
    this.repository = mock(UserRepository.class);
    this.createUserUseCase = mock(CreateUser.class);
    this.updateUserUseCase = mock(UpdateUser.class);
  ...
  void testAccessDeniedCreatable() {
    ...
    assertThrows(
        ...
        () -> this.useCase.upsertUser(user, null),
  ...
  void testWithoutIdAndAnchor() {
    ...
    verify(this.createUserUseCase).createUser(user, null);
  }
  ...
  void testWithId() {
    ...
    verify(this.updateUserUseCase).updateUser(user, null);
  }
  ...
  void testWithKnownAnchor() {
    ...
    verify(this.updateUserUseCase).updateUser(expected, null);
  }
