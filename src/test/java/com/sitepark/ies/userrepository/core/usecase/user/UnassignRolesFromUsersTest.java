...
class UnassignRolesFromUsersTest {
  ...
  private UnassignRolesFromUsers usecase;
  ...
  void testAssignRolesToUsers() {
    ...
    this.usecase.unassignRolesFromUsers(
        UnassignRolesFromUsersRequest.builder().userIds("1", "2").roleIds("3", "4").build());
  ...
  void testEmptyUsersIdentifiers() {
    ...
    this.usecase.unassignRolesFromUsers(
        UnassignRolesFromUsersRequest.builder().roleIds("3", "4").build());
  ...
  void testEmptyRolesIdentifiers() {
    this.usecase.unassignRolesFromUsers(
        UnassignRolesFromUsersRequest.builder().userIds("1", "2").build());
  ...
  void testResolveUserAnchor() {
    ...
    this.usecase.unassignRolesFromUsers(
        UnassignRolesFromUsersRequest.builder()
            .userIdentifier(Identifier.ofAnchor("anchor"))
            .roleIds("3", "4")
            .build());
