...
class CreateRoleTest {
  ...
  void setUp() {
    ...
    this.userCase = new CreateRole(this.repository, this.roleAssigner, this.accessControl);
  }
  ...
  void testValidateRoleWithId() {
    ...
    assertThrows(
        ...
        () -> this.userCase.createRole(role, null),
  ...
  void testCheckAccessControlRoleWritableForPrivilegesList() {
    ...
    assertThrows(
        AccessDeniedException.class,
        () -> this.userCase.createRole(role, new String[] {"123"}),
